...
import configs.registration_groupwise_affine as cfg
from data.train_reg_Data_Generator import DataLoaderGroupwiseTemplate
from losses.reg_losses import dice_loss, none_loss, MutualInformationVXM
...
def main(debug):
    ...
    ae_reg = mm_utils.reg_groupwise_affine(weighted=cfg.weighted)      #
    ...
    ae_reg.compile(optimizer=AdamOpt, loss=customLoss, loss_weights=loss_weights , metrics={'pred_lbl_affine': dice_loss().loss})
